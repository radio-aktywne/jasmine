...
import { PrerecordingsUploadPageView } from "./page.view";
...
async function getTitle({
  ...
  if (!queryParameters.show)
    return msg({ message: `Upload prerecording • jasmine` });
...
export default async function PrerecordingsUploadPage({
  searchParams,
  ...
  return (
    <Authenticated>
      ...
      <PrerecordingsUploadPageView queryParameters={queryParameters} />
    </Authenticated>
  );
}
