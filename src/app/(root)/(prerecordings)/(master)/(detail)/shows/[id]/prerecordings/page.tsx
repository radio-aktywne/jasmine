...
import { ShowsIdPrerecordingsPageView } from "./page.view";
...
export default async function ShowsIdPrerecordingsPage({
  params,
  ...
  return (
    <>
      ...
      <ShowsIdPrerecordingsPageView pathParameters={pathParameters} />
    </>
  );
}
