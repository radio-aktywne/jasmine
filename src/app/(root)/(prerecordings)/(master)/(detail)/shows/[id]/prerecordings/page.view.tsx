...
import { ListPrerecordingsWidget } from "../../../../../../../../client/core/components/list-prerecordings-widget";
...
export async function ShowsIdPrerecordingsPageView({
  pathParameters,
  ...
  return (
    <HydrationBoundary state={dehydrate(queryClient)}>
      <Hydrated fallback={<LoadingWidget />}>
        <ListPrerecordingsWidget id={pathParameters.id} />
      </Hydrated>
    </HydrationBoundary>
  );
}
